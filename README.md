# Boas vindas ao repositório do projeto de React Testing Library!
...
```bash
git clone git@github.com:apaulinhacarlos/trybe-front-react-testing-library/.git
```

Acesse o diretório do projeto com o comando `cd`:

```bash
cd trybe-front-react-testing-library
```
